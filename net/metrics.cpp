...
.chart-grid{display:flex;flex-direction:column;gap:16px;max-width:1200px}
.chart-box{background:#16213e;border-radius:8px;padding:16px;overflow:hidden}
.chart-box h2{font-size:14px;color:#aaa;margin-bottom:8px}
.chart-box canvas{display:block;width:100%;height:200px!important}
